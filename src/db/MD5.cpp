...
string MD5::encoding(const string &src)
{
...
string MD5::encode(const string &src)
{
    return MD5().encoding(src);
}

QString MD5::encode(const QString &src)
{
    return MD5().encoding(src.toStdString()).c_str();
}
